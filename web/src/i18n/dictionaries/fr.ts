...
const dict = {
  ...
  nav: {
    ...
    practice: 'S’entraîner', oral: 'Oral', progress: 'Progrès', community: 'Community', admin: 'Admin', settings: 'Paramètres',
  ...
  landing: {
    ...
    navStats: 'Pourquoi 5sosy',
    dashboard: 'Aller au tableau de bord',
    badge: 'Tuteur IA autonome · Thanaweya Amma',
    heroTitle: 'Un essaim de tuteurs IA, dans votre poche',
    heroSubtitle: 'Cherchez dans 34 796 pages de manuels officiels, obtenez des réponses sourcées à la page exacte, planifiez vos révisions, passez des quiz adaptatifs et entraînez-vous à l’oral — le tout dans votre langue.',
    trustNoInstall: 'Aucune installation',
    trustGrounded: 'Basé sur les manuels du ministère',
    trustFree: '100% gratuit',
    heroImageCaption: 'Des réponses sourcées à la page exacte du manuel',
    agentsTitle: 'Un assistant, tout un essaim derrière',
    agentsSub: 'Chaque question est dirigée vers un agent spécialiste, puis synthétisée en une réponse claire et sourcée.',
    featuresTitle: 'Pourquoi les élèves choisissent 5sosy',
    statsTitle: 'Bâti sur une base de connaissances sérieuse',
    statBooks: 'manuels',
    statPages: 'pages indexées',
    statAgents: 'agents spécialisés',
    statLangs: 'langues',
    features: [
      { title: 'Fondé, pas deviné', desc: 'Chaque réponse cite la page exacte de votre manuel officiel — sans hallucinations.' },
      { title: 'Parle votre langue', desc: 'Arabe égyptien, anglais et cinq autres — toute l’app suit votre choix.' },
      { title: 'Un plan qui s’adapte', desc: 'Il repère vos lacunes et reconstruit votre calendrier de révision autour.' },
      { title: 'Un entraînement réaliste', desc: 'Examens blancs chronométrés, oraux et quiz adaptés à votre niveau.' },
    ],
    agents: [
      { name: 'Orchestrateur', tagline: 'Comprend votre intention et la dirige vers le bon spécialiste.' },
      { name: 'AskMe', tagline: 'Recherche hybride vecteurs + mots-clés sur chaque page, avec citations.' },
      { name: 'Planificateur', tagline: 'Construit un plan de révision adaptatif autour de vos lacunes.' },
      { name: 'Évaluation', tagline: 'Génère des quiz et des examens blancs chronométrés qui s’adaptent.' },
      { name: 'Audio & Vision', tagline: 'Oral, explications audio, et lit les photos de votre caméra.' },
      { name: 'Bilan', tagline: 'Transforme vos progrès en rapports clairs pour les parents.' },
      { name: 'Recherche', tagline: 'Apporte des références externes fiables pour enrichir vos réponses.' },
    ],
    footerTagline: 'Votre compagnon d’étude IA pour la Thanaweya Amma.',
